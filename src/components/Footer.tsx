...
const Footer: React.FC<FooterProps> = ({ translations }) => {
  ...
  const handleEmailClick = () => {
    window.open('mailto:support@ruralhealthcarekiosk.com', '_blank');
  };
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          >
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              {translations.tagline}. We are committed to making quality healthcare accessible 
              to every rural community through innovative technology and affordable solutions.
            </p>
          ...
          >
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#problem" className="text-gray-300 hover:text-white transition-colors">Problem</a></li>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h4 className="text-lg font-semibold mb-4">{translations.contactUs}</h4>
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                >
                  support@ruralhealthcarekiosk.com
                </button>
              </div>
              <div className="flex items-center space-x-3">
